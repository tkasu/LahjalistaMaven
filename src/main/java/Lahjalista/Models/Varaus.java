...
public class Varaus {
    ...
    public void lisaaKantaan() throws SQLException, NamingException, URISyntaxException {
    ...
    public void paivitaKantaan(int vanhaLahjaId, int vanhaVaraajaId) throws SQLException, NamingException, URISyntaxException {
    ...
    public void poistaKannasta() throws NamingException, SQLException, URISyntaxException {
