...
public class Lahjaehdotus{
    ...
    public void paivitaKantaan() throws NamingException, SQLException, URISyntaxException {
    ...
    public void lisaaKantaan() throws NamingException, SQLException, URISyntaxException {
